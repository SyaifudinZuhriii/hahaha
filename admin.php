...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col">
              <div style="background-color:#eb34d8;" class="mt-4 p-5 text-light rounded">
                <h1>JURAYYY</h1>
                <p>NOUZER PERPUSTAKAAN</p>
              </div>
        ...
        <div class="row">
            <div class="col">
                <!-- NAVIGASI MENU ADMIN  -->
                    <nav style="background-color:#34ebde;" class="navbar navbar-expand-lg navbar-light">
